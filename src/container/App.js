...
class App extends Component {
  ...
  getAxiosRes(){
    ...
    onClickListItem(movie){
        this.setState({ currentMovie: movie }, () => {this.getVideoRes();
    ...
    getTextSearch(textSearch){
        axios.get(`${API_END_POINT}${SEARCH_URL}&${API_KEY}&query=${textSearch}`).then(function(res){
            ...
            // console.log('----------');
            // console.log('-----Bien click DANS APP------', res);
            // console.log('------------');
        }.bind(this));
        ...
        <div>
            ...
            <div className="row">
                <div className="col-md-8">
                    ...
                    <VideoDetails title={this.state.currentMovie.title} overview={this.state.currentMovie.overview} date={this.state.currentMovie.release_date}/>
                    {renderNoVideo()}
                </div>
